...
public class ImageIOImageData implements LoadableImageData {
	...
	public GLFWImage loadImageAsGLFWImage(InputStream fis, boolean flipped, boolean forceAlpha, 
		...
		BufferedImage bufferedImage = ImageIO.read(fis);
		return image.set(bufferedImage.getWidth(), bufferedImage.getHeight(), 
				imageToByteBuffer(bufferedImage, true, false, null));
	}
